...
public class ExMessage {
    ...
    public static final String IMPORTED_ITEM_MUST_BE_A_FILE = "Imported item must be a file.";

    public static final String WATCH_KEY_NOT_RECOGNISED = "WatchKey not recognized";
}
